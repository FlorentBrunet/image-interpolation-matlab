function vals = ii_bicubic(img, x, y, nthreads, default_value)
%II_BICUBIC Bicubic interpolation.
%
% vals = ii_bicubic(img, x, y)
% vals = ii_bicubic(img, x, y, nthreads)
% vals = ii_bicubic(img, x, y, [], default_value)
% vals = ii_bicubic(img, x, y, nthreads, default_value)
%
% DESCRIPTION
%  "ii_bicubic" is a fast implementation of the standard bicubic
...
%     DEFAULT_NTHREADS in "ii_bicubic.cpp".
%
% OUTPUT ARGUMENTS
